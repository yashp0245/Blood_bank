...
<style>
    body{
    background: url(jastimage/l4.jpg) no-repeat center;
				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Blood Group</label>
					...
					<a href="Userpage.html" class="text-center">Back</a><br>
				</div>
			</div>
		</div>
	</div>
